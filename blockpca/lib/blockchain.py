...
class Blockchain:
    ...
    def add_blockchain_entry(self, blockpca_hash, user_sig, user_public_key,
                             recipient_public_key):

        with open(self.file_name, 'ab') as chain_file:
            chain_file.write(blockpca_hash)
